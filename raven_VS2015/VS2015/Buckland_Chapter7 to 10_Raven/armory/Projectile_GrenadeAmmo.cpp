#include "Projectile_GrenadeAmmo.h"
...
//-------------------------- ctor ---------------------------------------------
//-----------------------------------------------------------------------------
GrenadeAmmo::GrenadeAmmo(Raven_Bot* shooter, Vector2D target) :
...
void GrenadeAmmo::TestForImpact()
{
...
//-----------------------------------------------------------------------------
void GrenadeAmmo::InflictDamageOnBotsWithinBlastRadius()
{
