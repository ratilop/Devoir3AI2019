; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27031.1 
	...
	TITLE	C:\Users\ntrembla71\Desktop\raven_VS2015\VS2015\Common\fuzzy\FuzzyOperators.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_1JM@FGJDHEBO@?$AAc?$AA?3?$AA?2?$AAu?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAn?$AAt?$AAr?$AAe?$AAm?$AAb@ ; `string'
...
??_C@_1FC@EJGEACIH@?$AA0?$AA?5?$AA?$CG?$AA?$CG?$AA?5?$AA?$CC?$AA?$DM?$AAF?$AAz?$AAO?$AAR?$AA?3?$AA?3?$AAC?$AAl@ DB '0'
	...
	DB	00H, 00H, 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_1JM@FGJDHEBO@?$AAc?$AA?3?$AA?2?$AAu?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAn?$AAt?$AAr?$AAe?$AAm?$AAb@
CONST	SEGMENT
??_C@_1JM@FGJDHEBO@?$AAc?$AA?3?$AA?2?$AAu?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAn?$AAt?$AAr?$AAe?$AAm?$AAb@ DB 'c'
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\ntrembla71\desktop\raven_vs2015\vs2015\common\fuzzy\fuzzyoperators.h
...
; 87   :   void ORwithDOM(double val){assert(0 && "<FzOR::ORwithDOM>: invalid context");}
	...
	push	87					; 00000057H
	push	OFFSET ??_C@_1JM@FGJDHEBO@?$AAc?$AA?3?$AA?2?$AAu?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAn?$AAt?$AAr?$AAe?$AAm?$AAb@
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\ntrembla71\desktop\raven_vs2015\vs2015\common\fuzzy\fuzzyterm.h
