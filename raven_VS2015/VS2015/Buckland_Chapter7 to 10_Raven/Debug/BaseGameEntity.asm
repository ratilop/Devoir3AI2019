; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27031.1 
	...
	TITLE	C:\Users\ntrembla71\Desktop\raven_VS2015\VS2015\Common\Game\BaseGameEntity.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_BSS	ENDS
CONST	SEGMENT
$SG154544 DB	'<BaseGameEntity::SetID>: invalid ID', 00H
	ORG $+4
$SG154545 DB	'c', 00H, ':', 00H, '\', 00H, 'u', 00H, 's', 00H, 'e', 00H
	...
	DB	'e', 00H, '\', 00H, 'b', 00H, 'a', 00H, 's', 00H, 'e', 00H, 'g'
	DB	00H, 'a', 00H, 'm', 00H, 'e', 00H, 'e', 00H, 'n', 00H, 't', 00H
	DB	'i', 00H, 't', 00H, 'y', 00H, '.', 00H, 'c', 00H, 'p', 00H, 'p'
	DB	00H, 00H, 00H
	ORG $+2
$SG154546 DB	'(', 00H, 'v', 00H, 'a', 00H, 'l', 00H, ' ', 00H, '>', 00H
...
; 26   :   assert ( (val >= m_iNextValidID) && "<BaseGameEntity::SetID>: invalid ID");
	...
	jl	SHORT $LN3@SetID
	mov	ecx, OFFSET $SG154544
	test	ecx, ecx
	jne	SHORT $LN4@SetID
$LN3@SetID:
	push	26					; 0000001aH
	push	OFFSET $SG154545
	push	OFFSET $SG154546
	call	__wassert
