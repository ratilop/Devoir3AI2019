; Listing generated by Microsoft (R) Optimizing Compiler Version 19.21.27702.2 
	...
	TITLE	C:\Users\Nathanael\Desktop\raven_VS2015\VS2015\Common\Game\BaseGameEntity.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_BSS	ENDS
CONST	SEGMENT
$SG151552 DB	'<BaseGameEntity::SetID>: invalid ID', 00H
	ORG $+4
$SG151553 DB	'C', 00H, ':', 00H, '\', 00H, 'U', 00H, 's', 00H, 'e', 00H
	...
	DB	00H
	ORG $+4
$SG151554 DB	'(', 00H, 'v', 00H, 'a', 00H, 'l', 00H, ' ', 00H, '>', 00H
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\Nathanael\Desktop\raven_VS2015\VS2015\Common\Game\BaseGameEntity.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
_ID$ = 8						; size = 4
...
; 26   :   assert ( (val >= m_iNextValidID) && "<BaseGameEntity::SetID>: invalid ID");
	...
	jl	SHORT $LN3@SetID
	mov	ecx, OFFSET $SG151552
	test	ecx, ecx
	jne	SHORT $LN4@SetID
$LN3@SetID:
	push	26					; 0000001aH
	push	OFFSET $SG151553
	push	OFFSET $SG151554
	call	__wassert
