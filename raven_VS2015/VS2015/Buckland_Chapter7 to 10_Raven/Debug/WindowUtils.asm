; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27031.1 
	...
	TITLE	C:\Users\ntrembla71\Desktop\raven_VS2015\VS2015\Common\misc\WindowUtils.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG153359 DB	'Error', 00H
	ORG $+2
$SG153363 DB	'Error', 00H
	ORG $+2
$SG153454 DB	'*.*', 00H
$SG153455 DB	'All Files (*.*)', 00H
$SG153456 DB	'*.', 00H
CONST	ENDS
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\ntrembla71\desktop\raven_vs2015\vs2015\common\misc\stream_utility_functions.h
...
; 109  :                        "All Files (*.*)" + '\0' + "*.*" + '\0' + '\0';
	...
	push	0
	push	0
	push	OFFSET $SG153454
	push	0
	push	OFFSET $SG153455
	push	0
	mov	eax, DWORD PTR _defaultFileExtension$[ebp]
	push	eax
	push	OFFSET $SG153456
	push	0
	mov	ecx, DWORD PTR _defaultFileTypeDescription$[ebp]
	push	ecx
