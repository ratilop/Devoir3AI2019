; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27031.1 
	...
	TITLE	C:\Users\ntrembla71\Desktop\Devoir3AI2019\raven_VS2015\VS2015\Buckland_Chapter7 to 10_Raven\Raven_TargetingSystem.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?GetEquipe@Raven_Bot@@QAE?AW4Equipe@1@XZ	; Raven_Bot::GetEquipe
PUBLIC	?setTarget@Raven_Bot@@QAEXPAV1@@Z		; Raven_Bot::setTarget
PUBLIC	?GetTargetMortel@Raven_Bot@@QAEPAV1@XZ		; Raven_Bot::GetTargetMortel
...
; 231  :   Raven_SensoryMemory* const         GetSensoryMem()const{return m_pSensoryMem;}
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\ntrembla71\desktop\devoir3ai2019\raven_vs2015\vs2015\buckland_chapter7 to 10_raven\raven_bot.h
;	COMDAT ?GetTargetMortel@Raven_Bot@@QAEPAV1@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?GetTargetMortel@Raven_Bot@@QAEPAV1@XZ PROC		; Raven_Bot::GetTargetMortel, COMDAT
; _this$ = ecx

; 182  : 	Raven_Bot*		GetTargetMortel() { return m_TargetMortel; }
	...
	pop	ebp
	ret	0
?GetTargetMortel@Raven_Bot@@QAEPAV1@XZ ENDP		; Raven_Bot::GetTargetMortel
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\ntrembla71\desktop\devoir3ai2019\raven_vs2015\vs2015\buckland_chapter7 to 10_raven\raven_bot.h
;	COMDAT ?setTarget@Raven_Bot@@QAEXPAV1@@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_ennemis$ = 8						; size = 4
?setTarget@Raven_Bot@@QAEXPAV1@@Z PROC			; Raven_Bot::setTarget, COMDAT
; _this$ = ecx

; 181  : 	void			setTarget(Raven_Bot* ennemis) { m_TargetMortel = ennemis;};
	...
	mov	DWORD PTR _this$[ebp], ecx
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _ennemis$[ebp]
	mov	DWORD PTR [eax+176], ecx
	mov	esp, ebp
	pop	ebp
	ret	4
?setTarget@Raven_Bot@@QAEXPAV1@@Z ENDP			; Raven_Bot::setTarget
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\ntrembla71\desktop\devoir3ai2019\raven_vs2015\vs2015\buckland_chapter7 to 10_raven\raven_bot.h
;	COMDAT ?GetEquipe@Raven_Bot@@QAE?AW4Equipe@1@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?GetEquipe@Raven_Bot@@QAE?AW4Equipe@1@XZ PROC		; Raven_Bot::GetEquipe, COMDAT
; _this$ = ecx

; 174  : 	Equipe			GetEquipe() { return m_Equipe; }					// donne quelle equipe que le bot est
	...
	pop	ebp
	ret	0
?GetEquipe@Raven_Bot@@QAE?AW4Equipe@1@XZ ENDP		; Raven_Bot::GetEquipe
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\ntrembla71\desktop\devoir3ai2019\raven_vs2015\vs2015\buckland_chapter7 to 10_raven\raven_bot.h
...
; 161  : 	bool          isDead()const { return m_Status == dead; }
...
; 90   :   return m_pOwner->GetSensoryMem()->GetTimeOpponentHasBeenOutOfView(m_pCurrentTarget);
...
; 85   :   return m_pOwner->GetSensoryMem()->GetTimeOpponentHasBeenVisible(m_pCurrentTarget);
...
; 80   :   return m_pOwner->GetSensoryMem()->GetLastRecordedPositionOfOpponent(m_pCurrentTarget);
...
; 75   :   return m_pOwner->GetSensoryMem()->isOpponentShootable(m_pCurrentTarget);
...
; 70   :   return m_pOwner->GetSensoryMem()->isOpponentWithinFOV(m_pCurrentTarget);
...
; 26   :   
; 27   :   if (m_pOwner->GetTargetMortel() != NULL)

	mov	ecx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [ecx]
	call	?GetTargetMortel@Raven_Bot@@QAEPAV1@XZ	; Raven_Bot::GetTargetMortel
	test	eax, eax
	je	SHORT $LN6@Update

; 28   :   {
; 29   : 	  if (m_pOwner->GetTargetMortel()->isDead())
...
; 30   : 	  {
; 31   : 		m_pOwner->setTarget(NULL);

	push	0
	mov	ecx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [ecx]
	call	?setTarget@Raven_Bot@@QAEXPAV1@@Z	; Raven_Bot::setTarget
$LN6@Update:
...
; 42   :     {
; 43   : 		if ((*curBot)->GetEquipe() != m_pOwner->GetEquipe() || (*curBot)->GetEquipe() == 0)

	lea	ecx, DWORD PTR _curBot$[ebp]
	call	??D?$_List_const_iterator@V?$_List_val@U?$_List_simple_types@PAVRaven_Bot@@@std@@@std@@@std@@QBEABQAVRaven_Bot@@XZ ; std::_List_const_iterator<std::_List_val<std::_List_simple_types<Raven_Bot *> > >::operator*
	mov	ecx, DWORD PTR [eax]
	call	?GetEquipe@Raven_Bot@@QAE?AW4Equipe@1@XZ ; Raven_Bot::GetEquipe
	mov	esi, eax
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax]
	call	?GetEquipe@Raven_Bot@@QAE?AW4Equipe@1@XZ ; Raven_Bot::GetEquipe
...
; 44   : 		{
; 45   : 			
; 46   : 		  double dist = Vec2DDistanceSq((*curBot)->Pos(), m_pOwner->Pos());
...
; 49   : 		  {
; 50   : 			ClosestDistSoFar = dist;

	movsd	xmm0, QWORD PTR _dist$8[ebp]
	movsd	QWORD PTR _ClosestDistSoFar$[ebp], xmm0

; 51   : 			m_pCurrentTarget = *curBot;
...
; 58   :   if (m_pOwner->GetTargetMortel() != NULL)
...
; 59   :   {
; 60   : 	  m_pCurrentTarget = m_pOwner->GetTargetMortel();
