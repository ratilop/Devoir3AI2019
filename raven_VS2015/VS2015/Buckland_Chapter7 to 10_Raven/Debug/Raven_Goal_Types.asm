; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27031.1 
	...
	TITLE	C:\Users\ntrembla71\Desktop\Devoir3AI2019\raven_VS2015\VS2015\Buckland_Chapter7 to 10_Raven\goals\Raven_Goal_Types.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG37059 DB	'explore', 00H
$SG37061 DB	'think', 00H
	ORG $+2
$SG37063 DB	'arrive_at_position', 00H
	ORG $+1
$SG37065 DB	'seek_to_position', 00H
	ORG $+3
$SG37067 DB	'follow_path', 00H
$SG37069 DB	'traverse_edge', 00H
	ORG $+2
$SG37071 DB	'move_to_position', 00H
	ORG $+3
$SG37073 DB	'get_health', 00H
	ORG $+1
$SG37075 DB	'get_shotgun', 00H
$SG37077 DB	'get_railgun', 00H
$SG37079 DB	'get_rocket_launcher', 00H
$SG37081 DB	'wander', 00H
	ORG $+1
$SG37083 DB	'negotiate_door', 00H
	ORG $+1
$SG37085 DB	'attack_target', 00H
	ORG $+2
$SG37087 DB	'hunt_target', 00H
$SG37089 DB	'strafe', 00H
	ORG $+1
$SG37091 DB	'adjust_range', 00H
	ORG $+3
$SG37093 DB	'say_phrase', 00H
	ORG $+1
$SG37095 DB	'UNKNOWN GOAL TYPE!', 00H
CONST	ENDS
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\ntrembla71\desktop\devoir3ai2019\raven_vs2015\vs2015\buckland_chapter7 to 10_raven\goals\raven_goal_types.h
