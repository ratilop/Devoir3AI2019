...
private:
	...
	int nb_target; // nombre de target à à considérer. Par défaut. c'est toujours 1.
...
public:
  ...
  void SetInputNb(int Input) { nb_input = Input; }
  void SetTargetsNb(int Target) {nb_target= Target; }
